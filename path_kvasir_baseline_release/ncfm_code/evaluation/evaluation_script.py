...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=True,
        help="Use training augmentation for synthetic evaluation data",
    )
    parser.add_argument(
        "--no_augment",
        dest="augment",
        action="store_false",
        help="Disable training augmentation for synthetic evaluation data",
    )
    parser.add_argument(
        "--eval_checkpoint_path",
        type=str,
        default=None,
        help="Path to save the best evaluator checkpoint",
    )
    parser.add_argument(
        "--eval_metrics_path",
        type=str,
        default=None,
        help="Path to save evaluator metrics as JSONL",
    )
