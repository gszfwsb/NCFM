...
run_eval() {
  echo
  echo "==> $*"
  "$PYTHON" tools/run_eval_repeats_parallel.py "$@"
}
...
run_cifar10() {
  run_eval --tag table1_c10_i1_vr10 \
    ...
    --ipc 1 --val-repeat 10 --gpu "$GPUS" --port-base 45000
  ...
  run_eval --tag table1_c10_i10_vr10 \
    ...
    --ipc 10 --val-repeat 10 --gpu "$GPUS" --port-base 45100
  ...
  run_eval --tag table1_c10_i50_vr10 \
    ...
    --ipc 50 --val-repeat 10 --gpu "$GPUS" --port-base 45200
}
...
run_cifar100() {
  run_eval --tag table1_c100_i1_vr10 \
    ...
    --ipc 1 --val-repeat 10 --gpu "$GPUS" --port-base 45300
  ...
  run_eval --tag table1_c100_i10_vr10 \
    ...
    --ipc 10 --val-repeat 10 --gpu "$GPUS" --port-base 45400
  ...
  run_eval --tag table1_c100_i50_vr10 \
    ...
    --ipc 50 --val-repeat 10 --gpu "$GPUS" --port-base 45500
}
...
run_tinyimagenet() {
  run_eval --tag table1_tiny_i1_vr10 \
    ...
    --ipc 1 --val-repeat 10 --gpu "$GPUS" --port-base 45600
  ...
  run_eval --tag table1_tiny_i10_vr10 \
    ...
    --ipc 10 --val-repeat 10 --gpu "$GPUS" --port-base 45700
  ...
  run_eval --tag table1_tiny_i50_vr10 \
    ...
    --ipc 50 --val-repeat 10 --gpu "$GPUS" --port-base 45800
}
